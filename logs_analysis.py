...
def high_error_days():
	...
	from (select count_404.date, 1.0*count_404.count/(count_404.count+count_200.count) \
	as percent from count_404, count_200 where count_404.date = count_200.date) as error_percent\
